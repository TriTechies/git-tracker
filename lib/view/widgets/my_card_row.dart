  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Obx(() => GestureDetector(
                onLongPress: () => controller.toggleSelection(0),
                ...
                child: Card(
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                      color: controller.selectedCards[0].value
                          ? Colors.blue
                          : Colors.transparent,
                      width: 2,
                    ),
          ...
          Obx(() => GestureDetector(
                onLongPress: () => controller.toggleSelection(1),
                onTap: () => controller.isInSelectionMode.value
                ...
                child: Card(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(10),
                    side: BorderSide(
                      color: controller.selectedCards[1].value
                          ? Colors.blue
                          : Colors.transparent,
                      width: 2,
                    ),
